// ActionScript file
private function date_manipulate(from_filter:String):String {
	var d:Date = new Date();
...
//		if (f_ent_date.length < 9)
			if (f_ent_date.indexOf("-") >= 0){
				...
				if(ent_datelen == 1){
					...
					ent_date_arr_result_day = trim(ent_date_arr_result_day);
				...
				if(ent_datelen == 2){
					...
					ent_date_arr_result_month = trim(ent_date_arr_result_month);
				...
				if(ent_datelen == 3){
					...
					ent_date_arr_result_year = trim(ent_date_arr_result_year);
